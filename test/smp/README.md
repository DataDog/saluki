...
contexts drawn from 10 metric names and randomized tags. Each scenario measures CPU, memory,
...
60-entry policy. All-miss policies use a disjoint prefix of the same length. Histogram outputs
...
This small corpus models selective routing of a few important metrics, not large-allowlist scaling.
