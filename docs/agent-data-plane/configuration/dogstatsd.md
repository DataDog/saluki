...
| `dogstatsd_experimental_http.enabled`                             | Enable experimental HTTP/H2C DSD listener          | Experimental HTTP path for pre-aggregated DogStatsD metrics; not implemented by ADP. Revisit if it leaves experimental status upstream or an ADP user needs it.                                                                                                           |
| `dogstatsd_experimental_http.listen_address`                      | Bind address for experimental HTTP DSD listener    | Experimental HTTP path for pre-aggregated DogStatsD metrics; not implemented by ADP. Revisit if it leaves experimental status upstream or an ADP user needs it.                                                                                                           |
