...
Enables Foldspace stateful encoding and gRPC transport for authoritative V3 counter, rate, and gauge series. Set series and sketches remain on their existing HTTP paths.
