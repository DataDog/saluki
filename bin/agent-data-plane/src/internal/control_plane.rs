...
pub struct PrivilegedApiWorker {
    ...
    dsd_config: DogStatsDControlPlaneConfiguration,
...
impl Supervisable for PrivilegedApiWorker {
    ...
    async fn initialize(&self, process_shutdown: ProcessShutdown) -> Result<SupervisorFuture, InitializationError> {
        let mut api_builder = APIBuilder::new()
            ...
            .with_handler(self.dsd_config.stats_config.api_handler())
            .with_optional_handler(self.dsd_config.capture_api_handler.clone());
