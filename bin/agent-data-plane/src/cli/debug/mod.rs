...
async fn set_log_level(api_client: DataPlaneAPIClient, config: SetLogLevelConfig) {
    match api_client
...
async fn set_metric_level(api_client: DataPlaneAPIClient, config: SetMetricLevelConfig) {
