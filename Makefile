...
test-correctness: test-correctness-dsd-plain test-correctness-dsd-origin-detection test-correctness-dsd-tag-filterlist-agent-adp test-correctness-otlp-metrics test-correctness-otlp-traces test-correctness-otlp-traces-ottl-filtering test-correctness-otlp-traces-ottl-transform
...
.PHONY: test-correctness-dsd-tag-filterlist-agent-adp
test-correctness-dsd-tag-filterlist-agent-adp: build-ground-truth
test-correctness-dsd-tag-filterlist-agent-adp: ## Runs the 'dsd-tag-filterlist-agent-adp' correctness test case
	@echo "[*] Running 'dsd-tag-filterlist-agent-adp' correctness test case..."
	@target/release/ground-truth $(shell pwd)/test/correctness/dsd-tag-filterlist-agent-adp/config.yaml
