...
async fn run_io_loop<B>(
    ...
    context: ComponentContext, config: ForwarderConfiguration,
    live_config: Option<ScopedConfig<DatadogForwarderConfig>>, service: HttpClient, telemetry: ComponentTelemetry,
...
async fn run_endpoint_io_loop<B>(
    ...
    config: ForwarderConfiguration, _live_config: Option<ScopedConfig<DatadogForwarderConfig>>, service: HttpClient,
