...
///
/// This handle is created before the source is built, then bound to the live capture runtime during source construction.
/// That lets other parts of the process hold a stable handle without reaching into the source internals.
