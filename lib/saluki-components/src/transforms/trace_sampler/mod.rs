...
impl TraceSamplerConfiguration {
    /// Creates a new `TraceSamplerConfiguration` from native values.
    pub fn from_native(otlp_sampling_percentage: f64) -> Self {
        let otlp_sampling_rate = normalize_sampling_rate(otlp_sampling_percentage / 100.0);
        Self {
