...
impl ApmStatsTransformConfiguration {
    /// Creates a new `ApmStatsTransformConfiguration` from its native configuration.
    pub fn from_native(config: &saluki_component_config::traces::ApmStatsTransformConfig) -> Self {
        Self {
