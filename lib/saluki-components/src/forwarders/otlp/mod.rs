...
impl OtlpForwarderConfiguration {
    /// Creates a new `OtlpForwarderConfiguration` from native values.
    pub fn from_native(core_agent_otlp_grpc_endpoint: String, core_agent_traces_internal_port: u16) -> Self {
        Self {
