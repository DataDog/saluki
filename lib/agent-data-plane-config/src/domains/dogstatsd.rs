...
use crate::defaults::{
    ...
    DEFAULT_DOGSTATSD_ALLOW_CONTEXT_HEAP_ALLOCS, DEFAULT_DOGSTATSD_BUFFER_COUNT, DEFAULT_DOGSTATSD_BUFFER_COUNT_MAX,
    DEFAULT_DOGSTATSD_CACHED_CONTEXTS_LIMIT, DEFAULT_DOGSTATSD_CACHED_TAGSETS_LIMIT,
    DEFAULT_DOGSTATSD_MAPPER_STRING_INTERNER_SIZE_BYTES, DEFAULT_DOGSTATSD_MINIMUM_SAMPLE_RATE,
