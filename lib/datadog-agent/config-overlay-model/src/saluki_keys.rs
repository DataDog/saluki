...
\
    ...
    SalukiKey {
        ...
        documentation: Some(concat!(
            ...
            "same prefix. ADP also rejects empty metric prefixes and tag names, tag names containing `:`, and leading ",
            "or trailing whitespace in prefixes, tag names, values, and replacements. Configure a replacement that ",
            "cannot collide with a real tag value.",
        )),
        value_type: "ValueType::String",
        schema_default: Some("[]"),
        env_vars: &[],
