...
pub static SALUKI_KEYS: &[SalukiKey] = &[
    ...
    SalukiKey {
        ...
        default: "false",
        documentation: Some(
            "Enables Foldspace stateful encoding and gRPC transport for authoritative V3 metric series. Sketches and \
             series fields not represented by the current Foldspace schema remain on their existing HTTP paths.",
        ),
    ...
    SalukiKey {
        ...
        env_var_override: None,
        additional_yaml_paths: &[],
        used_by: &["FORWARDER_CONFIGURATION"],
        test_json: None,
        pipeline_affinity: "PipelineAffinity::Pipelines(&[Pipeline::DogStatsD])",
