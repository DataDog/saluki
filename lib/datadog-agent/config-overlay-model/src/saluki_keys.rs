...
pub static SALUKI_KEYS: &[SalukiKey] = &[
    ...
    SalukiKey {
        ...
        description: "Enable Foldspace for V3 metric series",
        default: "false",
        documentation: Some(
            "Enables Foldspace stateful encoding and gRPC transport for authoritative V3 counter, rate, and gauge \
             series. Set series and sketches remain on their existing HTTP paths.",
        ),
    ...
    SalukiKey {
        ...
        description: "Foldspace batches in flight per destination",
        default: "32",
        documentation: Some(
            "Sets the bounded ordered in-flight window independently for each endpoint and API-key destination.",
        ),
        value_type: "ValueType::Integer",
        schema_default: Some("32"),
        env_vars: &[],
        env_var_override: None,
        additional_yaml_paths: &[],
        used_by: &["TYPED_CONFIG_SYSTEM"],
