...
/// entry, sorted alphabetically, and compiles as an ordinary module of the annotation registry.
...
pub fn generate_schema_rs(schema_map: &IndexMap<String, FieldInfo>, dir: &Path) {
    ...
    // The file lives under `src/`, where a new modification time costs a rebuild of the crate.
