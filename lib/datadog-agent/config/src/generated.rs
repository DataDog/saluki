...
pub struct DatadogConfiguration {
    ...
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub serializer_experimental_use_v3_api: Option<DatadogConfigurationSerializerExperimentalUseV3Api>,
...
pub struct DatadogConfigurationObservabilityPipelinesWorkerMetrics {
    ...
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub use_v3_api: Option<DatadogConfigurationObservabilityPipelinesWorkerMetricsUseV3Api>,
}
...
pub struct DatadogConfigurationSerializerExperimentalUseV3ApiSeries {
    #[serde(default = "defaults::datadog_configuration_serializer_experimental_use_v3_api_series_beta_route")]
    pub beta_route: String,

    #[serde(default, skip_serializing_if = "::std::vec::Vec::is_empty")]
    pub endpoints: Vec<String>,

    #[serde(default = "defaults::datadog_configuration_serializer_experimental_use_v3_api_series_shadow_sample_rate")]
    pub shadow_sample_rate: f64,

    #[serde(default = "defaults::datadog_configuration_serializer_experimental_use_v3_api_series_shadow_sites")]
...
impl Default for DatadogConfigurationSerializerExperimentalUseV3ApiSeries {
    fn default() -> Self {
        Self {
            ...
            shadow_sample_rate:
                defaults::datadog_configuration_serializer_experimental_use_v3_api_series_shadow_sample_rate(),
...
pub mod defaults {
    ...
    pub(super) fn datadog_configuration_serializer_experimental_use_v3_api_series_shadow_sites() -> Vec<String> {
