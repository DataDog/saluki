...
/// The worker driving an [`OriginResolver`]'s origin cache.
pub type OriginResolverWorker = CacheWorker<u64, ResolvedOrigin>;
...
impl OriginResolver {
    ...
    pub fn new(ed_resolver: ExternalDataStoreResolver) -> (Self, OriginResolverWorker) {
