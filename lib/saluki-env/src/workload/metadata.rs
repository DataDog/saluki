...
pub enum MetadataAction {
    ...
    ///
    /// This can be used to allow for querying for information about an entity, where the information isn't directly
    ...
    ///
    /// External Data is free-form string data that's attached to entities from external systems to allow resolving the
    /// entity's ID when it can't be passed directly to the entity such that the entity can provide it in telemetry
    /// payloads itself.
    AttachExternalData {
