...
def upload_fuzz(
    ...
    # We simply force the prefix to be `saluki-` for ease of filtering (until we improve that part on the API side)
    # As a note: more than 63 characters will be truncated by the API
    pkgname_prefix = "saluki-"
    pkgname = (
...
if __name__ == "__main__":
    ...
    for cargo_root in cargo_roots:
        ...
        for fuzz_test in fuzz_tests:
            ...
            # Make cargo_root relative to the root of the repository, so the generated target name is saluki-<foldername>-<fuzz-test>
